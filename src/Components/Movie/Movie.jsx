...
class Movie extends Component {
   ...
   async componentDidMount(){
    ...
    playVideo=async(obj)=>{
        let req=await axios.get(`${API_URL}/movie/${obj}/videos?api_key=${API_KEY}&language=en-US`);
    ...
    render() {
        ...
        return (
            ...
            <Link to={{ pathname: '/moviepage', query: { the: this.state.movieData } }}>
            <img src={posterPath} alt="movieImg" />
